...
**Рисунок иллюстрирует вычислительную архитектуру типа `______` поток команд, `_____` поток данных, `______`**  

![image](https://github.com/user-attachments/assets/7f7f7402-65e5-445a-836e-10e702ebfb84)

+ Множественный, Множественный, симметричный мультипроцессор с общей памятью
