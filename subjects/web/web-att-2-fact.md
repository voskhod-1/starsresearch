...
```
***
#### Постройте регулярное выражение, описывающее IP адрес. Кратко опишите словами структуру искомого шаблона.
- ^(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)(\.(25[0-5]|2[0-4]\d|1\d\d|[1-9]?\d)){3}$
***
#### Постройте регулярное выражение, описывающее текущую дату и время в формате: гггг-мм-дд чч:мм:сс. Кратко опишите словами структуру искомого шаблона.
- ^\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12][0-9]|3[01]) (?:[01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]$
***
#### Постройте регулярное выражение, описывающее вещественные числа в экспоненциальном формате. Кратко опишите словами структуру искомого шаблона. Пример входных данных:  -0.6е+2
- ^[+-]?(?:\d+\.?\d*|\.\d+)(?:[eE][+-]?\d+)?$
***
