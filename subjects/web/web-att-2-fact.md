...
|клиент запрашивает файл с расширением рl|веб-сервер организует выполнение сценария из файла|
|клиент запрашивает файл с расширением htm|веб-сервер передает содержимое файла кленту|
