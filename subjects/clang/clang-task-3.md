...
Как правило в заданиях требовалось каким-либо образом изменить массив. Желательно, чтобы массивы были динамическими(т.е. хранились в heap'e). Работа исключительно через указатели
```cpp
#include <iostream>
#include <cstring>
using namespace std;
