...
***
#### Отметьте пункты,определяющие наличие/отсутствие в реляционном отношении потенциального ключа
...
Преподаватель может преподавать не более одной дисциплины (в том числе может и не преподавать ни одной).\
Дисциплина обязательно должна преподаваться одним, но только одним преподавателем.
![диаграмма 40](https://github.com/user-attachments/assets/74b041c9-7906-4463-9347-448ee61157c7)
***
#### Укажите степень связи, которая имеет место в приведённом примере:
**{фамилия} - {номер страхового полиса}**
- один-ко-многим
***
#### Укажите степень связи, которая имеет место в приведённом примере:
...
***
#### Укажите степень связи, которая имеет место в приведённом примере:
**{номер страхового полиса} - {фамилия}**
- многие-к-одному
***
...
- [x] **Наличие в системе специальных средств для обеспечения заданного уровня достоверности хранимой информации**
- [ ] Ориентация на обеспечение достоверности хранимой информации повышенными требованиями к квалификации и дисциплинированности персонала, осуществляющего ввод и обработку данных
- [x] **Обеспечение возможности выполнения произвольных запросов внешних пользователей на получение информации**
- [ ] Повышенные специальные требования к квалификации использующих данные пользователей в области информационных технологий
- [x] **Возможность удовлетворения информационных потребностей разнообразных пользователей информации без предъявления специальных требований к квалификации**
- [ ] Организация и использование представленной в базе данных информации для максимально эффективного решения конкретной задачи, поставленной заказчиками
- [ ] Разделение и распределение данных по разным системам в соответствии с использующими эти данные задачами
- [x] **Интеграция (объединение) данных, используемых разными пользователями и задачами**
- [ ] Требование обеспечения максимально эффективной выборки информации в соответствии с заранее определёнными, чёткими критериями поиска
- [x] **Обеспечение возможности поиска и выборки информации по произвольным, заранее не определённым группам признаков**
- [ ] Ориентация на максимально эффективное удовлетворение информационных потребностей чётко определённого круга квалифицированных пользователей информации 
- [x] **Устранение дублирования и избыточности хранимых данных**
- [ ] Ориентация на эффективное удовлетворение заранее выявленных, чётко определённых запросов внешних пользователей на получение информации
- [ ] Использование дублирования и избыточности данных с целью повышения эффективности решения конкретной задачи
- [x] **Использование хранимой в базе данных информации для решения разнообразных слабо связанных друг с другом задач**
- [x] **Отсутствие специальных требований к квалификации пользователей в области информационных технологий**
***
...
***
#### Отметьте пункты, отражающие свойства более характерные для систем с базами данных
- [ ] структуры данных должны выбираться исходя из требований обеспечения максимально эффективного выполнения использующих их программ
- [x] **должна быть обеспечена возможность изменения структур данных без изменения кода использующих их программ**
- [x] **снижение требований к уровню подготовки возможных пользователей информации в области информационных технологий**
- [ ] повышение требований к уровню подготовки возможных пользователей информации в области информационных технологий
- [ ] структуры данных тесно связаны с кодом использующих их программ
- [x] **структуры данных должны быть максимально независимы от использующих эти данные программ**
- [x] **данные являются более дорогостоящими компонентами информационной системы, чем программный код**
- [ ] программный код является более дорогостоящим компонентом информационной системы, чем данные 
