...
3. Как только получены все нужные справки, вы идёте в социальную защиту с ними и документами и заказываете справку о том, что вы малоимущий(если скажете, что для соц. стипендии – вас поймут)
