[Назад](../README.md)
***
# Полезные ресурсы для учебы(NoAD)
...
+ [Qwen(нейронка от Алибабы, которая поддерживает до 1 млн символов)](https://qwenlm.ai/)

+ [Grok(нейронка от Маска, не работает без VPN)](https://grok.com/)

+ [deepseek(нашумевшая нейросеть от китайцев)](https://deepseek.com/)
...
+ [Хелпдеск](https://cs.vsu.ru/hdesk)
